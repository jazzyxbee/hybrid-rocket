...
std::array<double,3> calculateAngularAccelerations(double Ix,double Iy, double Iz, double omega_x, double omega_y, double omega_z, double tau_x, double tau_y, double tau_z) {
    ...
    return {w_x_dot,w_y_dot,w_z_dot };
}
